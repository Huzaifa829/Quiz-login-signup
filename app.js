...
User_auth_data == null ? User_auth_arr = [] : User_auth_arr = User_auth_data;
...
signup_form.addEventListener('submit', (e) => {
    ...
    if (!passwordRegex.test(signup_password.value)) {
        alertify.error('Password must be at least 5 characters long, with special Character,Captial letter ');
        return;
    }
...
// getting true or false by checking email
    ...
    check_method = User_auth_arr.some(item => item.email === signup_email.value);
